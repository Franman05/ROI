...
def Investments(Total_Investment, Rent, Repairs):
    MaxInvestment = Rent * 12 - Repairs
    Investments = (MaxInvestment/Total_Investment) * 200 #Changing this output will change the return in investment
    print(Investments)

Investments(Total_Investment, Rent, Repairs)
